...
my_label.pack()
player = tkvideo("home/buga/wetter-sceen/pictures/sample.mp4", my_label, loop=1, size=(864,486))
player.play()
...
# Load Image
UTCIImage = tk.PhotoImage(file="home/buga/wetter-sceen/pictures/UTCI-Chart.png")
UTCIImage = UTCIImage.subsample(2) #Resize 1/2
canvas.create_image(45, 10, anchor="nw", image=UTCIImage)

# Draw Arrow with Text
UTCIArrow = tk.PhotoImage(file="home/buga/wetter-sceen/pictures/UTCI-Arrow.png")
